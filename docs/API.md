...
| GET | /audit/actors | admin | audit | → `{ id, name, email }[]` (distinct actors in the log, deleted users included) |
...
against bullmq 5.81.4 on a live Redis: it is an auxiliary SET at
