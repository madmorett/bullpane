...
export const routes = {
  ...
  /** per-queue schedulers tab */
  queueSchedulers: (cid: string, q: string) => `/c/${e(cid)}/q/${e(q)}/schedulers`,
  /** every scheduler of a connection, across queues */
  schedulers: (cid?: string) => (cid ? `/schedulers/${e(cid)}` : "/schedulers"),
  health: "/health",
  folders: "/folders",
