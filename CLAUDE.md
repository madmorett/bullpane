...
Files that live there: the production install notes for the first customer, the launch checklist and the commercial ops runbook (`private/bullpane/LAUNCH.md`, `BULLPANE-OPS.md`),
