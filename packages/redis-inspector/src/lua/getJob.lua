--[[
  ...
  Returns nil when the hash does not exist, otherwise
    { hgetallFlat, logs, logsCount, dependenciesCount, processedCount, state }
...
elseif rcall("ZSCORE", KEYS[9], id) then state = "delayed"
...
return { hash, logs, logsCount, depsCount, processedCount, state }
